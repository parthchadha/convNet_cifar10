...
def main(x = 1, save=1, num_epochs=100,alpha=0.001,mv=0.9,l2_rate = 0.001):
	...
	file_name = 'model_' + str(x)+ '_2_alpha_' + str(alpha) +'_momentum_' + str(mv) + '_l2_reg_' + str(l2_rate)+'_with_dropout_lt_in_dense.npz'
	...
	data_file_name = 'data_value_all_model_' +str(x) +'_2_alpha_'+ str(alpha) +'_momentum_' + str(mv) + '_l2_reg_' + str(l2_rate)+'_with_dropout_lt_in_dense.pckl'
